...
class DCGAN():
    ...
    def train(self, epochs, batch_size=128, save_interval=50):
        ...
        try:
            ...
            print('{} folder created'.format(self.to_pre))
        except:
        ...
        for epoch in range(epochs):
            ...
            if epoch % save_interval == 0:
                ...
                self.generator.save_weights('weights/{0}/{1}_gen.h5'.format(self.to_pre,epoch))
                self.discriminator.save_weights('weights/{0}/{1}_dis.h5'.format(self.to_pre,epoch))
    ...
    def predict_(self,epochs,number_of_images):
        for epoch in epochs:
            ...
            if 'Final_Predict' not in os.listdir("predict"):
                os.mkdir('predict/Final_Predict/')

            if self.to_pre not in os.listdir("predict/Final_Predict/"):
                os.mkdir('predict/Final_Predict/{}'.format(self.to_pre))

            try:
                os.mkdir('predict/Final_Predict/{0}/{1}'.format(self.to_pre,epoch))
            except:
                pass
            to_save_dir = 'predict/Final_Predict/{0}/{1}'.format(self.to_pre,epoch)
            ...
            for i in range(number_of_images):
                ...
                try:
                    ...
                    self.generator.load_weights('weights/{0}/{1}_gen.h5'.format(self.to_pre,epoch))
                    self.discriminator.sload_weights('weights/{0}/{1}_dis.h5'.format(self.to_pre,epoch))
                except:
